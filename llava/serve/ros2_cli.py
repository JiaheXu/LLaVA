...
class llava_node(Node):
    def __init__(self, args):
        super().__init__('{}_llava_node'.format(args.ros_namespace))
        ...
        self.questions.append("Are his arms injured")
        self.questions.append("Are his legs injured?")
        self.questions.append("Is his head injured?")              
    ...
    def timer_callback(self):
        ...
        self.image = copy.deepcopy( self.sample_img )
